        ...
        val adapter = FragmentsAdapter(
            listOf(
                ...
                Demo(
                    ...
                    buildArgs(false, false)
                ),
                Demo(
                    "ViewPager+Fragment+内嵌Fragment", ViewPagerFragment::class.java.name,
                    buildArgs(false, true)
                ),
//            Demo("AdapterView点击事件Fragment",
//                AdapterViewFragment::class.java.name, buildArgs(false, false)),
                Demo(
                    "AdapterView点击事件Fragment",
...
//                RxBindingFragment::class.java.name, buildArgs(false, false, true))
    ...
    private fun buildArgs(
        isVisibilityEnable: Boolean, isChildrenEnable: Boolean,
    ...
    ) : RecyclerView.Adapter<FragmentsHolder>() {
