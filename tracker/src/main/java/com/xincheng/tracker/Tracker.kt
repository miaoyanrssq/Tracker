...
import com.xincheng.tracker.lifecycle.TrackerActivityLifeCycle
import com.xincheng.tracker.data.*
import com.xincheng.tracker.utils.getTrackProperties
import com.xincheng.tracker.utils.initBuildInProperties
import java.util.*
import kotlin.collections.HashMap
import com.xincheng.tracker.utils.login as buildInLogin
import com.xincheng.tracker.utils.logout as buildInLogout
...
//    }
  ...
  internal fun onForeground() {
    ...
    if (isInitialized) {
      ...
      event.addProperties(properties)
      com.xincheng.tracker.utils.trackEvent(event, foreground = true)
    }
    isBackground = false
  }
